...
import { aiHistory, aiTools, aiUsage, createAiTask, readAiTask, removeAiTask } from "../controllers/aiController.js";
...
aiRoutes.post("/run", optionalAuth, aiRateLimit, upload.array("files", 5), validateAiUpload, asyncHandler(createAiTask));
