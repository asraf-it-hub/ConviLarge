...
import { BadgeCheck, Download, Image, Loader2, Type, WandSparkles } from "lucide-react";
        ...
        {needsWatermark && (
          <div className="mt-5 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="col-span-2 block text-sm font-semibold">
                Pages
                <input className="focus-ring mt-2 h-11 w-full rounded-lg border border-slate-200 bg-white px-3 dark:border-slate-700 dark:bg-slate-950" value={pageRange} onChange={(event) => setPageRange(event.target.value)} placeholder="All pages or 1-3,5" />
              </label>
              <label className="col-span-2 block text-sm font-semibold">
                Logo position
