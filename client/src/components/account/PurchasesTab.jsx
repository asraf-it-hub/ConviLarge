export default function PurchasesTab() {
  const purchases = [
    { id: "p-101", item: "Pro Plan Subscription (1 Month)", date: "June 11, 2026", amount: "$9.99", status: "Completed" },
    { id: "p-102", item: "Pro Plan Subscription (1 Month)", date: "May 11, 2026", amount: "$9.99", status: "Completed" },
    { id: "p-103", item: "Pro Plan Subscription (1 Month)", date: "April 11, 2026", amount: "$9.99", status: "Completed" },
    { id: "p-104", item: "API Starter Pack (500 Credits)", date: "March 20, 2026", amount: "$15.00", status: "Completed" }
  ];
