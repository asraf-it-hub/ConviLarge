...
export const toolCatalog = [
  ...
  tool({ id: "ai-document-translator", category: "ai", name: "AI Document Translator", description: "Translate PDFs, DOCX, PPTX, and TXT files while keeping structure readable.", keywords: ["ai", "translate", "document", "pdf", "docx", "pptx", "language"], icon: FileText, accept: "application/pdf,.pdf,.docx,.pptx,.txt,text/plain,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.presentationml.presentation", maxFiles: 1 }),
